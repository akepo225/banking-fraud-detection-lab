...
- `12_capstone_private_banking.sql` is the v0.9 capstone private-banking
  ...
  lifecycle lineage. Run it against a capstone dataset generated by
  `uv run python -m banking_fraud_lab.capstone --track private_banking --seed 42 --scale tiny --learner-facing --output data/capstone`.
- `13_capstone_digital_banking.sql` is the v0.9 capstone digital-banking
  ...
  `new_beneficiary_payment` Detection patterns and Alert lifecycle lineage. Run it
  against a capstone dataset generated by
