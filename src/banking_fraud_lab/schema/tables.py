    ...
    PARTNERS: TableSpec(
        ...
        columns=(
            ...
            ColumnSpec(
                ...
                "datetime64[ns]",
                False,
                "Timestamp when the current KYC risk band became effective.",
            ),
            ColumnSpec(
                "kyc_risk_reviewed_at",
                "datetime64[ns]",
                False,
                "Timestamp when the current KYC risk band was last reviewed.",
            ),
        ),
    ),
    CLIENTS: TableSpec(
    ...
    ACCOUNTS: TableSpec(
        ...
        columns=(
            ...
            ColumnSpec(
                ...
                "datetime64[ns]",
                False,
                "Timestamp when the current account status became effective.",
            ),
            ColumnSpec(
                "status_effective_to",
                "datetime64[ns]",
                True,
                "Timestamp when the account status ended, if closed or superseded.",
            ),
    ...
    USERS: TableSpec(
        ...
        columns=(
            ...
            ColumnSpec(
                ...
                "datetime64[ns]",
                False,
                "Timestamp when the current digital authorization became effective.",
            ),
            ColumnSpec(
                "authorized_to",
                "datetime64[ns]",
                True,
                "Timestamp when the digital authorization ended, if revoked.",
            ),
        ),
    ),
    SESSIONS: TableSpec(
        ...
        columns=(
            ...
            ColumnSpec("user_agent", "string", False, "Synthetic browser or app user-agent family."),
            ColumnSpec(
                "app_or_browser_version",
                "string",
                False,
                "Synthetic app or browser version observed in the session.",
            ),
            ...
            ColumnSpec(
                ...
                "string",
                False,
                "Coarse city or region-level geolocation signal.",
            ),
    ...
    PAYMENT_BENEFICIARIES: TableSpec(
        ...
        columns=(
            ...
            ColumnSpec(
                ...
                "string",
                False,
                "Beneficiary lifecycle event such as creation or update.",
            ),
    ...
    ALERTS: TableSpec(
        ...
        columns=(
            ...
            ColumnSpec(
                ...
                "datetime64[ns]",
                False,
                "Timestamp when the current alert status was assigned.",
            ),
    ...
    CASES: TableSpec(
        ...
        columns=(
            ...
            ColumnSpec(
                ...
                "datetime64[ns]",
                True,
                "Case closure timestamp, populated for closed cases.",
            ),
    ...
    CASE_OUTCOMES: TableSpec(
        ...
        columns=(
            ...
            ColumnSpec(
                ...
                "datetime64[ns]",
                False,
                "Timestamp when the outcome was recorded in the case lifecycle.",
            ),
